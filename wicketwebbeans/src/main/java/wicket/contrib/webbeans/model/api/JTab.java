...
public class JTab implements Tab, Serializable
{
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#label()
     */
    public String label()
    {
        return label;
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#properties()
     */
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#propertyNames()
     */
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#paramName()
     */
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#paramValue()
     */
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#params()
     */
    ...
    /** 
     * {@inheritDoc}
     * @see wicket.contrib.webbeans.annotations.Tab#name()
     */
    public String name()
    {
        return name;
