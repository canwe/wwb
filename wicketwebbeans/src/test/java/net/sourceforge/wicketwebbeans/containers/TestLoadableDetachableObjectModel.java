 ...
 * @author Dan Syrstad
 */
public class TestLoadableDetachableObjectModel extends LoadableDetachableModel
{
    private static final long serialVersionUID = 4107532879860694959L;

    /**
     * Construct a TestLoadableDetachableObjectModel. 
     *
     */
    public TestLoadableDetachableObjectModel()
    {
    }
